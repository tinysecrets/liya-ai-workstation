...
- **CRITICAL:** Do NOT hallucinate "sub-agents" or output raw JSON to spawn background tasks. You must physically CALL the \`research\` or \`deep_research\` function/tool synchronously right now. Do not say you are doing it in the background.
